...
export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <main className="page service-page">
    ...
    <section className="service-section">
      <div className="section-head"><span>Pricing</span><h2>Choose your package</h2><p>No more crunched-up paragraphs. Pricing is organized into clean cards so customers can understand the package fast.</p></div>
      <PriceCards s={s} />
