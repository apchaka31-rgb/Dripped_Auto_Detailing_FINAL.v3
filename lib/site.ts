...
export const galleryItems = [
  { file: "IMG_0553.JPEG", title: "Mercedes SUV Exterior Detail", category: "Exterior Details", vehicle: "Mercedes-Benz SUV", label: "After Detail", description: "Clean white paint, dressed tires, streak-free glass, and a sharp mobile detail finish." },
  { file: "IMG_0567.JPEG", title: "Chevrolet Silverado Exterior Detail", category: "Truck Details", vehicle: "Chevrolet Silverado", label: "After Detail", description: "Full-size truck exterior wash with tires, wheels, glass, and trim cleaned up." },
  { file: "IMG_2139.JPEG", title: "Range Rover Gloss Finish", category: "Exterior Details", vehicle: "Range Rover", label: "After Detail", description: "Black Range Rover with a clean glossy finish and premium presentation." },
  { file: "IMG_2150.JPEG", title: "Range Rover Exterior Detail", category: "Exterior Details", vehicle: "Range Rover", label: "After Detail", description: "White Range Rover cleaned, dressed, and finished with a luxury-detail appearance." },
  { file: "IMG_2144.JPEG", title: "Mercedes GLE Exterior Detail", category: "Exterior Details", vehicle: "Mercedes-Benz GLE", label: "After Detail", description: "Clean exterior finish on a luxury SUV after mobile detailing service." },
  { file: "IMG_2380.JPEG", title: "Mercedes Engine Bay Detail", category: "Engine Bay", vehicle: "Mercedes-Benz", label: "After Engine Bay Detail", description: "Engine bay cleaned and dressed for a more professional, presentable finish." },
  { file: "IMG_2384.JPEG", title: "Mercedes Engine Bay Before", category: "Before & After", vehicle: "Mercedes-Benz", label: "Before Engine Bay Detail", description: "Dusty engine bay before cleaning and dressing." },
  { file: "IMG_3489.JPEG", title: "Corvette Gloss Detail", category: "Performance Vehicles", vehicle: "Chevrolet Corvette", label: "After Detail", description: "High-gloss finish on a red Corvette after premium exterior care." },
  { file: "IMG_3490.JPEG", title: "Mercedes S-Class Detail", category: "Luxury Vehicles", vehicle: "Mercedes-Benz S-Class", label: "After Detail", description: "Luxury sedan detailed with a clean, glossy, client-ready finish." },
  { file: "IMG_3456.JPEG", title: "BMW Wheel Detail", category: "Wheels & Tires", vehicle: "BMW M", label: "After Wheel Detail", description: "Wheel, tire, and fender area cleaned for a crisp close-up finish." },
  { file: "IMG_3496.JPEG", title: "BMW Exterior Detail", category: "Performance Vehicles", vehicle: "BMW M", label: "After Detail", description: "Black BMW cleaned and finished with a deep gloss look." },
  { file: "IMG_3740.JPEG", title: "BMW Foam Wash", category: "Before & After", vehicle: "BMW M", label: "During Foam Wash", description: "Foam wash process breaking down dirt and grime before the final rinse and finish." },
  { file: "IMG_3738.JPEG", title: "GMC Sierra Foam Wash", category: "Before & After", vehicle: "GMC Sierra", label: "During Foam Wash", description: "Truck covered in foam during the exterior wash process." },
  { file: "IMG_3736.JPEG", title: "GMC Sierra Finished Detail", category: "Before & After", vehicle: "GMC Sierra", label: "After Detail", description: "Clean white GMC Sierra after wash, wheels, tires, and exterior finishing." },
  { file: "IMG_3926.JPEG", title: "Rivian Exterior Detail", category: "Electric Vehicles", vehicle: "Rivian", label: "After Detail", description: "Rivian SUV detailed and finished with a clean mobile detail presentation." },
  { file: "IMG_4635.JPEG", title: "Jaguar SUV Detail", category: "Luxury Vehicles", vehicle: "Jaguar SUV", label: "After Detail", description: "Gray Jaguar SUV cleaned and dressed after mobile detailing." },
  { file: "IMG_4650.JPEG", title: "Dodge Charger Detail", category: "Performance Vehicles", vehicle: "Dodge Charger", label: "After Detail", description: "White Dodge Charger cleaned and finished for a sharp exterior look." },
  { file: "IMG_4649.JPEG", title: "GMC AT4 Exterior Detail", category: "Truck Details", vehicle: "GMC AT4", label: "After Detail", description: "Black GMC truck finished with clean paint, tires, and trim." },
  { file: "IMG_4664.JPEG", title: "GMC AT4 Foam Wash", category: "Before & After", vehicle: "GMC AT4", label: "During Foam Wash", description: "Foam stage during exterior detail service before rinse and final finish." },
  { file: "IMG_4671.JPEG", title: "GMC AT4 Finished Detail", category: "Before & After", vehicle: "GMC AT4", label: "After Detail", description: "White GMC AT4 finished after exterior wash and tire dressing." }
] as const;

export const beforeAfterPairs = [
  { title: "Mercedes Engine Bay Transformation", before: "IMG_2384.JPEG", after: "IMG_2380.JPEG", beforeLabel: "Before", afterLabel: "After", description: "Engine bay cleaning and dressing for a cleaner, more professional presentation." },
  { title: "GMC Sierra Exterior Wash Process", before: "IMG_3738.JPEG", after: "IMG_3736.JPEG", beforeLabel: "Foam Wash", afterLabel: "Final Finish", description: "A full-size truck during the foam wash stage and after the finished exterior detail." },
  { title: "GMC AT4 Foam to Finish", before: "IMG_4664.JPEG", after: "IMG_4671.JPEG", beforeLabel: "Foam Wash", afterLabel: "After Detail", description: "Foam stage followed by a clean finished truck with dressed tires and clear paint." }
] as const;
...
export const faqs = [
  ...
  { q: "Do I need to provide water or power?", a: "We can discuss the setup when booking. If water or power is available, it can help, but the appointment details will be confirmed before service." },
